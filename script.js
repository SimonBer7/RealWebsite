        ...
        <div class="flip-card">
                <div class="flip-card-inner">
                    ...
                    <div class="flip-card-back">
                        ...
                        <p>Výška: <span id="vyska">${this.vyska}</span> cm</p>
                        <p>Váha: <span id="vaha">${this.vaha}</span> kg</p>
...
class Evidence {
    ...
    printPlayers() {
        ...
        document.getElementsByClassName(".panel").innerHTML = html;
